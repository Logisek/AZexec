...
- [Azure Resource Manager Enumeration](#️-azure-resource-manager-enumeration-multi-subscription)
  - [Storage Account Enumeration](#storage-account-enumeration-storage-enum)
  - [Key Vault Enumeration](#key-vault-enumeration-keyvault-enum)
  - [Network Resource Enumeration](#network-resource-enumeration-network-enum)
  - [File Shares Enumeration](#azure-file-shares-enumeration-shares-enum)
  - [Managed Disks Enumeration](#azure-managed-disks-enumeration-disks-enum)
  - [BitLocker Enumeration](#bitlocker-enumeration-bitlocker-enum)
  - [Spider](#spider-spider)
  - [File Transfer](#file-transfer-get-file--put-file)
- [Credential Extraction](#-credential-extraction---netexec---sam--lsa--ntds-equivalent)
...
- [Command Examples by Feature](#-command-examples-by-feature)
  - [Process Enumeration](#process-enumeration-process-enum)
  - [Lockscreen Backdoor Enumeration](#lockscreen-backdoor-enumeration-lockscreen-enum)
  - [Intune/Endpoint Manager Enumeration](#intuneendpoint-manager-enumeration-intune-enum)
  - [OAuth2 Delegation Enumeration](#oauth2-delegation-enumeration-delegation-enum)
